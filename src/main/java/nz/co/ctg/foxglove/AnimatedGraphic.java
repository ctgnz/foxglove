 ...
 * createGroup} alone would return, paired with an {@link SvgAnimationController} to play, pause, stop and seek whatever animations the document declared. A new, additive entry
 * point (#30): {@code createGroup()}/{@code
