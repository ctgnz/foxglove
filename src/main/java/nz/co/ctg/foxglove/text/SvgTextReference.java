...
@XmlType(name = "", propOrder = {
    "presentation", "graphics", "text", "conditionalFeatures", "linkable", "externalResources", "eventListener", "content"
})
@XmlRootElement(name = "tref")
public class SvgTextReference extends AbstractSvgElement implements ISvgTextPositioningElement, ISvgLinkable {
