...
@XmlType(name = "", propOrder = {
    "presentation", "graphics", "text", "conditionalFeatures", "linkable", "externalResources", "content"
})
@XmlRootElement(name = "pattern")
public class SvgPattern extends AbstractSvgElement implements ISvgStylable, ISvgConditionalFeatures, ISvgLinkable, ISvgExternalResources, ISvgFitToViewBox {
