...
public class SvgAnimateTransform extends AbstractSvgAnimationElement implements ISvgAccumulatableAnimationElement {
    ...
    public Optional<Animation> buildAnimation(Node target, RenderContext context) {
        return SvgAnimateTransformBuilder.build(this, target);
    }
