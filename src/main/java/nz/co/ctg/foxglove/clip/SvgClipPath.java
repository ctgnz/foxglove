...
public class SvgClipPath extends AbstractSvgElement implements ISvgClipElement, ISvgPresentationAttributes, ISvgGraphicsAttributes, ISvgTextAttributes, ISvgConditionalFeatures, ISvgExternalResources, ISvgTransformable {
