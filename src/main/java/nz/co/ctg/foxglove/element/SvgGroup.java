...
public class SvgGroup extends AbstractSvgElement implements ISvgStructuralElement, ISvgStylable, ISvgEventListener, ISvgTransformable, ISvgConditionalFeatures {
    ...
    public Group createGroup() {
        ...
        transform.applyTransforms(group);
        if (content != null) {
