...
public class SvgGroup extends AbstractSvgElement implements ISvgStructuralElement, ISvgPresentationAttributes, ISvgGraphicsAttributes, ISvgTextAttributes, ISvgExternalResources, ISvgEventListener, ISvgTransformable, ISvgConditionalFeatures {
