...
@XmlType(name = "", propOrder = {
    "presentation", "graphics", "text", "conditionalFeatures", "linkable", "externalResources", "eventListener", "transform", "content"
})
@XmlRootElement(name = "use")
public class SvgUse extends AbstractSvgElement implements ISvgStructuralElement, ISvgStylable, ISvgEventListener, ISvgConditionalFeatures, ISvgTransformable, ISvgLinkable {
