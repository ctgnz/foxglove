...
@XmlType(name = "", propOrder = {
    "presentation", "graphics", "text", "externalResources", "eventListener", "content"
})
@XmlRootElement(name = "symbol")
public class SvgSymbol extends AbstractSvgElement implements ISvgStructuralElement, ISvgStylable, ISvgEventListener, ISvgFitToViewBox {
