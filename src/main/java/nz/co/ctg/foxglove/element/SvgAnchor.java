...
@XmlType(name = "", propOrder = {
    "presentation", "graphics", "text", "conditionalFeatures", "linkable", "externalResources", "eventListener", "transform", "value"
})
@XmlRootElement(name = "a")
public class SvgAnchor extends AbstractSvgElement implements ISvgStructuralElement, ISvgStylable, ISvgConditionalFeatures, ISvgLinkable, ISvgEventListener, ISvgTransformable, ISvgValueElement {
