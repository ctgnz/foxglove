...
public class SvgSwitch extends AbstractSvgElement implements ISvgStructuralElement, ISvgStylable, ISvgEventListener, ISvgExternalResources, ISvgConditionalFeatures, ISvgTransformable {
