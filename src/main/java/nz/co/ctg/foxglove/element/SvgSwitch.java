...
public class SvgSwitch extends AbstractSvgElement implements ISvgStructuralElement, ISvgPresentationAttributes, ISvgGraphicsAttributes, ISvgTextAttributes, ISvgEventListener, ISvgExternalResources, ISvgConditionalFeatures, ISvgTransformable {
