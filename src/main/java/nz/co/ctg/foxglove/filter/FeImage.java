...
@XmlType(name = "", propOrder = {
    "presentation", "graphics", "text", "linkable", "externalResources", "filter", "animations"
})
@XmlRootElement(name = "feImage")
public class FeImage extends AbstractSvgElement implements ISvgFilterPrimitive, ISvgExternalResources, ISvgLinkable {
