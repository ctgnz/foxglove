...
public class SizeAdapterTest {
    ...
    public void testUnmarshalNoUnitsAsPixels() throws Exception {
        assertThat(candidate.unmarshal("120")
            .pixels(), is(120.0));
        assertThat(candidate.unmarshal("12.345")
            .pixels(), is(12.345));
    }

    @Test
    public void testUnmarshalPixels() throws Exception {
        assertThat(candidate.unmarshal("120px")
            .pixels(), is(120.0));
        assertThat(candidate.unmarshal("12.345px")
            .pixels(), is(12.345));
    }
    ...
    public void testUnmarshalPercent() throws Exception {
        assertThat(candidate.unmarshal("120%")
            .pixels(), is(1.2));
        assertThat(candidate.unmarshal("123.45%")
            .pixels(), is(1.2345));
    }

    @Test
    public void testUnmarshalCentimetres() throws Exception {
        assertThat(candidate.unmarshal("12cm")
            .pixels(), closeTo(453.54, 0.01));
        assertThat(candidate.unmarshal("12.345cm")
            .pixels(), closeTo(466.58, 0.01));
    }

    @Test
    public void testUnmarshalMillimetres() throws Exception {
        assertThat(candidate.unmarshal("120mm")
            .pixels(), closeTo(453.54, 0.01));
        assertThat(candidate.unmarshal("12.345mm")
            .pixels(), closeTo(46.66, 0.01));
    }

    @Test
    public void testUnmarshalInches() throws Exception {
        assertThat(candidate.unmarshal("12in")
            .pixels(), is(1152.0));
        assertThat(candidate.unmarshal("12.345in")
            .pixels(), closeTo(1185.12, 0.01));
    }

    @Test
    @Disabled
    public void testUnmarshalEms() throws Exception {
        assertThat(candidate.unmarshal("12em")
            .pixels(Font.font("SansSerif")), is(144.0));
        assertThat(candidate.unmarshal("1.2em")
            .pixels(Font.font("SansSerif")), is(14.4));
    }

    @Test
    @Disabled
    public void testUnmarshalExs() throws Exception {
        assertThat(candidate.unmarshal("12ex")
            .pixels(Font.font("SansSerif")), is(72.0));
        assertThat(candidate.unmarshal("1.2ex")
            .pixels(Font.font("SansSerif")), is(7.2));
    }

    @Test
    public void testUnmarshalPoints() throws Exception {
        assertThat(candidate.unmarshal("120pt")
            .pixels(), is(160.0));
        assertThat(candidate.unmarshal("12.345pt")
            .pixels(), closeTo(16.46, 0.01));
    }

    @Test
    public void testUnmarshalPicas() throws Exception {
        assertThat(candidate.unmarshal("12pc")
            .pixels(), is(192.0));
        assertThat(candidate.unmarshal("12.345pc")
            .pixels(), is(197.52));
    }
