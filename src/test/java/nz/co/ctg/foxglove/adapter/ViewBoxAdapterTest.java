...
public class ViewBoxAdapterTest {
    ...
    public void testUnmarshalNoUnitsAsPixels() throws Exception {
        ...
        assertThat(viewBox.getMinX()
            .pixels(), is(0.0));
        assertThat(viewBox.getMinY()
            .pixels(), is(0.0));
        assertThat(viewBox.getWidth()
            .pixels(), is(800.0));
        assertThat(viewBox.getHeight()
            .pixels(), is(600.0));
    }
    ...
    public void testUnmarshalMillimetres() throws Exception {
        ...
        assertThat(viewBox.getMinY()
            .pixels(), is(0.0));
        assertThat(viewBox.getWidth()
            .pixels(), closeTo(3023.6, 0.05));
        assertThat(viewBox.getHeight()
            .pixels(), closeTo(2267.7, 0.05));
    }
