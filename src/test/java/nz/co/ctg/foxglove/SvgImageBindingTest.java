...
/**
 * {@code SvgImage}'s binding was missing the {@code x}/{@code y}/{@code width}/{@code height} ({@link nz.co.ctg.foxglove.ISvgBounded}) mappings entirely, along with the
 * {@code style}/{@code class}/ presentation/graphics/text attribute boilerplate every other structural element declares - the same class of bug fixed for {@code <use>} in #19 (see
 * {@link SvgBoundedBindingTest}), just more of it. Parsing a document was silently leaving every one of these {@code null} regardless of what the XML said, including
 * {@code display}, which controls whether the element renders at all.
 */
