 ...
 * <p>
 * Discovery logs a non-critical warning suggesting {@code @SelectPackage("features")} instead - tried that first,
 * but it discovers zero tests ({@code NoTestsDiscoveredException}) against this project's actual classpath layout,
 * so {@link SelectClasspathResource} stays despite the warning; it is the one that actually finds the feature file.
 */
@Suite
