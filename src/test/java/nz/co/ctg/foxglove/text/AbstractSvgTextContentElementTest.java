...
/**
 * Exercises the mixed-content flattening shared by {@link SvgText}, {@link SvgTextSpan} and {@link SvgTextPath} (#1), via {@link SvgTextSpan} as the simplest concrete subclass.
 */
public class AbstractSvgTextContentElementTest {
    ...
    public void testValueOfMixedContentFallsBackToTheFirstChildElement() throws Exception {
        ...
        assertThat(span.getTextContent()
            .get(0), is(child));
    }
