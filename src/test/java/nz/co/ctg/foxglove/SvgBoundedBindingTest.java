...
/**
 * {@code x}/{@code y}/{@code width}/{@code height} on {@code <use>} are bound through the OXM virtual accessors, the same mechanism {@link SvgLinkableBindingTest} covers for
 * {@code xlink:href} - and were missing from the binding entirely, which left every {@code <use>} silently un-positioned even though {@link nz.co.ctg.foxglove.ISvgBounded} parsed
 * them fine from a document built in memory.
 */
