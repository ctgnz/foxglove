...
public class FoxgloveParserTest {
    ...
    public void testParseLine() throws Exception {
        ...
        printElement(line);
        Line fxLine = line.createGraphic(RenderContext.root(null, 0, 0).resolveChild(group));
    ...
    public void testParseRectangle() throws Exception {
        ...
        printElement(rect);
        Rectangle fxRect = rect.createGraphic(RenderContext.root(null, 0, 0).resolveChild(group));
    ...
    public void testParsePolys() throws Exception {
        ...
        Polyline fxPolyline = polyline.createGraphic(RenderContext.root(null, 0, 0).resolveChild(group));
