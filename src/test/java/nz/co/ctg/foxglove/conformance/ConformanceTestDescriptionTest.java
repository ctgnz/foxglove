...
/**
 * Covers pulling a test's own pass criteria out of its source document (#110) - the part of a test page that says
 * what was actually being checked, which no pixel ratio conveys.
 */
