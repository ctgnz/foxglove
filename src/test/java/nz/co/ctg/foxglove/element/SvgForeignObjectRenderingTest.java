...
/**
 * Exercises #23's {@code <foreignObject>} acceptance criterion: either delegates to a supplied handler or degrades cleanly, and does not silently swallow content without a way to
 * know.
 */
public class SvgForeignObjectRenderingTest {
    ...
    public void testHandlerReturnedNodeIsEmbeddedAndPositioned() throws Exception {
        ...
        Rectangle placeholder = (Rectangle) rendered.getChildren()
            .get(0);
    ...
    public void testRawContentCapturesRealNestedXhtml() throws Exception {
        ...
        SvgForeignObject foreignObject = (SvgForeignObject) svg.getContent()
            .get(0);
        ...
        assertThat(foreignObject.getRawContent()
            .getTagName(), is("div"));
        assertThat(foreignObject.getRawContent()
            .getTextContent(), is("Hello world"));
    }
    ...
    private static Node render(SvgForeignObject foreignObject, ForeignObjectHandler handler) {
        ...
        return svg.createGraphic(context)
            .getChildren()
            .get(0);
    }
